...
var WebSocketQueue = (function (_super) {
    ...
    function WebSocketQueue(ws, psk) {
        ...
        ws.on("message", function (d) {
            ...
            if (recvPacket.t === "h" && recvPacket.a) {
                ...
                var sendKey = crypto.createHash("sha256").update(psk + recvPacket.o.toString(16)).digest("base64");
    ...
    Object.defineProperty(WebSocketQueue.prototype, "opened", {
        get: function () {
    ...
    WebSocketQueue.prototype.close = function () {
        this.ws.close();
    };
